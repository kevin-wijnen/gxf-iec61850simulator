...
class EventDataListener implements ServerEventListener {
    ...
    public List<ServiceError> write(final List<BasicDataAttribute> bdas) {
        ...
        try {
            for (final BasicDataAttribute bda : bdas) {
                modified = this.processBda(modified, bda);
            }
    ...
    boolean processBda(boolean modified, final BasicDataAttribute bda) {
        ...
        final BdaProcessor processor = BdaProcessorFactory.createProcessorFrom(this.device, bda);
        processor.process();
        ...
        case "enable": {
            ...
            try {
                ...
                // OOP Class
                this.device.getRelay(relayIndex).getSchedule(scheduleIndex).setEnabled(((BdaBoolean) bda).getValue());
        ...
        case "day": {
            ...
            try {
                ...
                final int currentDay = this.device.getRelay(relayIndex).getSchedule(scheduleIndex).getDayInt();
