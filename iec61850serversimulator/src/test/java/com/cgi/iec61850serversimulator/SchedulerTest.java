...
class SchedulerTest {
	...
	public void mockFixedTimeScheduleScheduler(int indexNumber, int relayNr, int dayInt, LocalTime timeOn,
		...
		this.device.getRelay(1).getSchedule(1).setDayInt(dayInt);
		this.device.getRelay(1).getSchedule(1).setTimeOn(timeOn);
		this.device.getRelay(1).getSchedule(1).setTimeOnTypeInt(0);
		this.device.getRelay(1).getSchedule(1).setTimeOff(timeOff);
		this.device.getRelay(1).getSchedule(1).setTimeOffTypeInt(0);
		this.device.getRelay(1).getSchedule(1).setBurningMinsOn(burningMinutes);
	}
